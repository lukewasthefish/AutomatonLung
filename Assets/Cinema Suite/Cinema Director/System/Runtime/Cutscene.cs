...
namespace CinemaDirector
{
    ...
    public class Cutscene : MonoBehaviour, IOptimizable
    {
        ...
        [SerializeField]
        public string destinationScene = ""; // Duration of cutscene in seconds.

        [SerializeField]
        public int destinationPlayerStart = 0; //Which player start do we start at in the destination scene?
        ...
        public void Stop()
        {
            ...
            {
                GameManager.Instance.SetDestinationPlayerStart(this.destinationPlayerStart);

                if (destinationScene != "")
                GameManager.Instance.LoadAfterDelay(0.5f, destinationScene);
            }
